...
class TestStringType(unittest.TestCase):
    ...
    def test_float(self):
        try:
            ...
            self.assertEqual('3: Should be a string', ex.message)
...
class TestIntegerType(unittest.TestCase):
    ...
    def test_float(self):
        try:
            ...
            self.assertEqual('3: Should be an integer', ex.message)
    ...
    def test_boolean(self):
        try:
            ...
            self.assertEqual('Should be an integer', ex.message)
...
class TestNumberType(unittest.TestCase):
    ...
    def test_boolean(self):
        try:
            ...
            self.assertEqual('Should be a number', ex.message)
...
class TestBooleanType(unittest.TestCase):
    ...
    def test_float(self):
        try:
            ...
            self.assertEqual('3: Should be a boolean', ex.message)
...
class TestStringMap(unittest.TestCase):
    ...
    def test_float(self):
        try:
            ...
            self.assertEqual('3: Should be an object', ex.message)
    ...
    def test_list(self):
        try:
            ...
            self.assertEqual('Should be an object', ex.message)
