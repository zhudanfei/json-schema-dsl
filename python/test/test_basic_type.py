...
class TestStringType(unittest.TestCase):
    ...
    def test_integer(self):
        try:
            ...
            self.assertEqual('node.3: Should be a string', ex.message)

    def test_float(self):
        try:
            basic_type.string_type(3.4, ['node', '3'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node.3: Should be a string', ex.message)
...
class TestIntegerType(unittest.TestCase):
    ...
    def test_string(self):
        try:
            ...
            self.assertEqual('node.3: Should be an integer', ex.message)

    def test_float(self):
        try:
            basic_type.integer_type(3.4, ['node', '3'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node.3: Should be an integer', ex.message)
    ...
    def test_boolean(self):
        try:
            basic_type.integer_type(False, ['node'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node: Should be an integer', ex.message)
...
class TestNumberType(unittest.TestCase):
    ...
    def test_string(self):
        try:
            ...
            self.assertEqual('node.3: Should be a number', ex.message)
    ...
    def test_boolean(self):
        try:
            basic_type.number_type(False, ['node'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node: Should be a number', ex.message)
...
class TestBooleanType(unittest.TestCase):
    ...
    def test_string(self):
        try:
            basic_type.boolean_type('6abc', ['node', '3'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node.3: Should be a boolean', ex.message)

    def test_integer(self):
        try:
            basic_type.boolean_type(4, ['node'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node: Should be a boolean', ex.message)

    def test_float(self):
        try:
            basic_type.boolean_type(3.4, ['node'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node: Should be a boolean', ex.message)
...
class TestStringMap(unittest.TestCase):
    ...
    def test_string(self):
        try:
            basic_type.string_map('6abc', ['node', '3'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node.3: Should be an object', ex.message)

    def test_integer(self):
        try:
            basic_type.string_map(4, ['node'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node: Should be an object', ex.message)

    def test_float(self):
        try:
            basic_type.string_map(3.4, ['node'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node: Should be an object', ex.message)
    ...
    def test_list(self):
        try:
            basic_type.string_map([1, 3, 5], ['node'])
            self.assertTrue(False)
        except TypeError as ex:
            self.assertEqual('node: Should be an object', ex.message)
    ...
    def test_caontains_non_string(self):
        try:
            ...
            self.assertEqual('d: Should be a string', ex.message)
